<template>
  <div class="view-body">
    ...
    <!-- phone length alert -->
    <AlertModal v-on:close="phoneLengthAlert = !phoneLengthAlert" message="please enter your full 10-digit phone number including the area code" v-bind:active="phoneLengthAlert"/>
        ...
        <div class="card">
          <div class="card-content">
            ...
            <div class="content">
              <p>
                Name:
                <strong>{{ currentDonor.given_name }} {{ currentDonor.family_name }}</strong>
              </p>
              <p>
                Phone:
              ...
              <p>
                Email:
                <strong>{{ currentDonor.email_address }}</strong>
              </p>
            </div>
            <button v-on:click="confirmDonor" class="button is-success is-medium">Confirm</button>
